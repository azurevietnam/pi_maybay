...
if(count($data)>0) {
	...
	foreach($data->value as $val) {
        ...
        if(date("d/m/Y", strtotime($_POST['ReturnDate'])) != date("d/m/Y", strtotime($_POST['DepartDate']))) {
                                            ...
                                            if($val->AirlineCode == "VietJetAir" || $val->AirlineCode == "JetStar") {
                                                ...
                                                if($Adult) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center" class="pax pb-price"><?=number_format(money_format('%(#10n', $val->Price), 0, ',','.')?> vnđ</td>
                                                        <td align="center" class="pax pb-price"><?php echo number_format(money_format('%(#10n', $price_tax), 0, ',','.'); ?> vnđ</td>
                                                        <td align="center" style="display:none;" class="pax pb-price">0 vnđ</td>
                                                        <td align="center" class="pax pb-price"><?php echo number_format(money_format('%(#10n', $price_total1), 0, ',','.'); ?> vnđ</td>
                                                    </tr>
                                                <?php }
                                                if($Child) {
                                                    $Price = $val->Price;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center" class="pax pb-price"><?php echo number_format(money_format('%(#10n', $price_tax), 0, ',','.'); ?> vnđ</td>
                                                        <td align="center" style="display:none;" class="pax pb-price">0 vnđ</td>
                                                        <td align="center" class="pax pb-price"><?php echo number_format(money_format('%(#10n', $price_total2), 0, ',','.'); ?> vnđ</td>
                                                    </tr>
                                                <?php } ?>
                                                <tr class="total-b">
                                                    ...
                                                    <td align="center" class="footer pb-price" colspan="2">
                                                        <p><?php echo number_format(money_format('%(#10n', $price_total1 + $price_total2 + $price_total3)); ?> vnđ</p>
                                                    </td>
                                                </tr>
                                            <?php }
            ...
            {
                if($RoundTrip == "true") {
//                    var_dump(date("d/m/Y", $departTime));
//                    var_dump(date("d/m/Y", strtotime($_POST['DepartDate'])));
                    if($Type == "depart") {
            ...
            {
                if($RoundTrip == "true") {
                    var_dump($val->FromPlace);
                    var_dump($_POST['TFromPlace']);
                    if($Type == "depart") {
                        if($val->FromPlace == $_POST['TFromPlace']) { ?>
                            <tr class="i-result">
                                <td class="logo-air"><img src="<?php echo SITE_NAME ?>/view/default/theme/images/<?=$val->AirlineCode?>.png" alt="" /><p><?=$val->FlightNumber?></p></td>
