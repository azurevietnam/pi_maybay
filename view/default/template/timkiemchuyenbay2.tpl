            ...
            <script>
                $(document).ready(function () {
                    ...
                    $("#thoigian_sx").click(function () {
                        ...
                        $deferered = Array();
                        $deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj', {data_post}, "VietJetAir,JetStar,VietnamAirlines", "depart", DepartTime, "result_depart_html"));
                        $deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj', {data_post}, "VietJetAir,JetStar,VietnamAirlines", "landing", DepartTime, "result_landing_html"));
                    })

                    $("#hang_sx").click(function () {
                        var Hang = "1";
                        $deferered = Array();
                        $deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj', {data_post}, "VietJetAir,JetStar,VietnamAirlines", "depart", Hang, "result_depart_html"));
                        $deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj', {data_post}, "VietJetAir,JetStar,VietnamAirlines", "landing", Hang, "result_landing_html"));
                    })
                ...
                $(function () {
					...
					$("#slider-range").slider({
						change: function (event, ui) {
							...
							$deferered = Array();
							$deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj2', {data_post}, "VietJetAir,JetStar,VietnamAirlines", "depart", amu, "result_depart_html"));  //time-0-17
                    ...
                    $("#slider-range_ve").slider({
                        change: function (event, ui) {
                            ...
                            $deferered = Array();
                            $deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj2', {data_post}, "VietJetAir,JetStar,VietnamAirlines", "landing", amu, "result_landing_html"));  //time-0-17
