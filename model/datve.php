...
class datve
{
    public $Id,$TrangThaiThanhToan,$MaDatVe,$HangBay,$LoaiVe,$ChieuDi,$ChieuVe,$NgayDi,$NgayVe,$SoNguoiLon,$SoTreEm,$ThanhTien,$NguoiDaiDien,$Phone,$Email,$Address,$YeuCau,$MaSoThue,$TenCongTy,$DiaChiNhanHoaDon,$HTTT,$NgayDat;
